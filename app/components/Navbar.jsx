...
const Navbar = ({isDarkMode, setIsDarkMode}) => {
    ...
    return(
        <>
        <div className='fixed top-0 right-0 w-11/12 -z-10 opacity-50 dark:hidden'>
            <Image src={assets.header_bg_color} alt="" className='w-full' />
        </div>
          <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%]  
          py-4 flex items-center justify-between z-50 ${isScroll ? "bg-white bg-opacity-50 backdrop-blur-lg shadow-sm dark:bg-darkTheme dark:shadow-white/20" : ""}`}>
            <a href="">
            ...
            <ul className={`hidden md:flex items-center
             gap-6 lg:gap-8 rounded-full px-12 py-3 ${isScroll ? "bg-white dark:bg-darkTheme shadow-sm" : "shadow-sm bg-opacity-50 dark:border dark:border-white/50 dark:bg-transparent "}`}>
           ...
           <div className='flex items-center gap-4'>
                ...
                border-gray-500 rounded-full ml-4 font-Ovo'>Contact 
