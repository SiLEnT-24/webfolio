    ...
    return(
        ...
        id="work" className='w-full px-[12%] py-10 scroll-mt-20'>
            ...
            className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>
               Welcome to my Web development Webfolio! Explore a collection of projects. 
            </motion.p>
               ...
               <motion.div
                ...
                className='aspect-square bg-no-repeat bg-cover bg-center rounded-lg relative cursor-pointer group'
                 key={index} style={{backgroundImage: `url(${project.bgImage})`}}>
                    ...
                    px-3 flex items-center justify-between duration-500 group-hover:bottom-7'>
        ...
        href="" className='flex w-max items-center justify-center gap-2 text-gray-700 
